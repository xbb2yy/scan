...
final public class Patterns {
   ...
   public static final Pattern a3end = Pattern.compile("(([\\d])\\2{2,})$");
   public static final Pattern a4p = Pattern.compile("([\\d])\\1{3,}");
   public static final Pattern aabb = Pattern.compile("(\\d)\\1(\\d)\\2\\b");
   ...
   public static final Pattern one6s = Pattern.compile("^(?=\\d*(\\d)\\d*(?:\\1\\d*){5})\\d{11}$");
